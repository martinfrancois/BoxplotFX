 ...
 * @author Dieter Holz
 */
public class TestSkin extends SkinBase<BusinessControl> {
...
//            this.text = text;
//            String url = TestSkin.class.getResource("icons/" + file).toExternalForm();
...
//    private FadeTransition fadeOutValidIconAnimation;
    ...
    public TestSkin(BusinessControl control) {
        super(control);
        initializeSelf();
        initializeParts();
        layoutParts();
...
//            rectangle.heightProperty().setValue(newValue);
//            System.out.println("y: " + newValue);
        });

        drawingPane.widthProperty().addListener((observable, oldValue, newValue) -> {
//            rectangle.widthProperty().setValue(newValue);
            System.out.println("x: " + newValue);
            rectangle.widthProperty().setValue(newValue);
            System.out.println(rectangle.widthProperty().get());
        });
